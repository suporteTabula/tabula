		...
		<table class="table table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="{{ route('course.item.edit.teacher', ['id' => $item_child->id]) }}">
							<img style=" width:35px; " src="{{asset('images\edit.svg')}}">
						</a>
					</td>
					<td>
						<a class="remove-record" data-toggle="modal" data-id={{$item_child->id}} data-target="#custom-width-modal" data-url="{{ route('course.item.delete.teacher', ['id' => $item_child->id]) }} ">
